...
int tst_cmdParserSS()
{
    ...
    CmdLineArgsSS args{ };
    bool flag1{ false };               args.ConfigureFlag("flag1", &flag1);
    bool flag2{ false };               args.ConfigureFlag("flag2", &flag2);
    std::string param1{ "default" };   args.ConfigureParam("param1", &param1);
    CmdLineArgsSS::StringList list1;   args.ConfigureNamedList("list1", &list1);
    CmdLineArgsSS::StringList unnamed; args.ConfigureUnnamedList(2, 2, &unnamed);
